...
namespace Lexicon_MVC_Storage_11.Controllers
{
    public class ProductsController : Controller
    {
        private readonly Lexicon_MVC_Storage_11Context _context;

        public ProductsController(Lexicon_MVC_Storage_11Context context)
        {
            _context = context;
        }
